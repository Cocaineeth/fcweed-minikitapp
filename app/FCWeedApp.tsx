                    ...
                    <div style={{ background: theme === "light" ? "#fff" : "linear-gradient(135deg, #0a1128, #1a2744)", borderRadius: 16, padding: 20, maxWidth: 420, width: "100%", maxHeight: "85vh", overflowY: "auto", border: "1px solid rgba(39,117,202,0.3)" }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 12, marginBottom: 16 }}>
                            {usdcShopItems.filter(item => item.active).map(item => {
                                ...
                                const itemColor = item.mainShopId === 3 ? "#ef4444" : item.mainShopId === 4 ? "#10b981" : item.mainShopId === 8 ? "#f59e0b" : "#a855f7";
                                const itemImg = item.mainShopId === 3 ? "/images/items/nuke.gif" : item.mainShopId === 4 ? "/images/items/healthpack.gif" : item.mainShopId === 8 ? null : "/images/items/attackboost.gif";
                                const isCropDuster = item.mainShopId === 8;
